                ...
                this.setState({
                    peoplesCuts: data.records.map((record: any) => {
                        return {
                            ...
                            data:
                                record.fields["Any data or sources to share?"],
                        };
                    }),
                });
            })
                ...
                this.setState({
                    peoplesReinvestments: data.records.map((record: any) => {
                        return {
                            name:
                                record.fields[
                                    "What should the City invest in?"
                                ],
    ...
    render() {
        return (
            ...
            >
                ...
                <p>
                    The People's Budget is a collaborative effort to source
                    meaningful cuts and reinvestments that reduce policing and
                    meet our community needs. We're asking you to weigh in — all
                    of the ideas here have been contributed by fellow community
                    members, and we've love for you to add your own.
                </p>
                <p>
                    Explore these cuts and re-investments, and add your own
                    suggestions! Keep in mind, this is open source, so we want
                    data and justifications, but we reject the idea of
                    "expertise". The people know best what we need!
                </p>
                <h2>THE PEOPLE'S CUTS</h2>
                <p>
                    Where should we cut the NYPD budget? What programs do you
                    think need to go? How can we most effectively defund the
                    NYPD? Here, we're looking for your specific suggestions and
                    research!
                </p>
                <p>
                    Add your suggestions for the people's cuts{" "}
                    <a
                        href="https://airtable.com/shrNhlxrqvXcCvJ4o"
                        target="_blank"
                    >
                        here
                    </a>
                ...
                <p>
                    How should we invest at least a billion dollars in our
                    communities? Housing? Healthcare? Youth Services? What
                    programs and services do we need?
                </p>
                <p>
                    Add your reinvesmtent suggestions{" "}
                    <a
                        href="https://airtable.com/shrpWjt2QNm9kgebH"
                        target="_blank"
                    >
                        here
                    </a>
